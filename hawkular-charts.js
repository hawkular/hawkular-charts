        ...
        function AvailabilityChartDirective() {
            ...
            this.link = function (scope, element, attrs) {
                ...
                function oneTimeChartSetup() {
                    ...
                    chart = chartParent.append("svg").attr('viewBox', '0 0 760 150').attr('preserveAspectRatio', 'xMinYMin meet');
    ...
    angular.module('hawkular.charts').directive('hawkularChart', ['$rootScope', '$http', '$interval', '$log', function ($rootScope, $http, $interval, $log) {
        ...
        function link(scope, element, attrs) {
            ...
            function initialization() {
                ...
                chartParent = d3.select(element[0]);
                chart = chartParent.append("svg").attr('viewBox', '0 0 760 250').attr('preserveAspectRatio', 'xMinYMin meet');
                createSvgDefs(chart);
