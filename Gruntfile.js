...
module.exports = function(grunt) {
  ...
  function init() {
    ...
    grunt.initConfig({
      ...
      copy: {
        docdata: {
          cwd: 'lib/hawkular-charts/dist',
          src: ['fonts/*', 'img/*'],
          dest: 'dist/docs',
          expand: true
        },
        fa: {
          cwd: 'lib/hawkular-charts/',
...
//      ngdocs: {
//        options: {
//          title: 'Hawkular Charts Documentation',
//          dest: 'dist/docs',
//          scripts: ['lib/hawkular-charts/components/jquery/jquery.js',
//            'lib/hawkular-charts/components/bootstrap/dist/js/bootstrap.js',
//            'angular.js',
//            'dist/hawkular-charts.js',
//            'lib/hawkular-charts/dist/js/hawkular-charts.js'],
//          html5Mode: false,
//          styles: ['lib/hawkular-charts/dist/css/hawkular-charts.css']
//        },
//        all: ['src/**/*.js']
//      },
//      ngtemplates: {
...
//
      ...
      uglify: {
        ...
        build: {
          files: {},
          src: 'dist/hawkular-charts.js',
          dest: 'dist/hawkular-charts.min.js'
        }
      },
      watch: {
        main: {
