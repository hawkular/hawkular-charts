...
data format as *data* but only *timestamp* and *value*
fields are required. The *forecastData* can provide as many or as little data points as desired (but the spacing
