...
__"Legos of Metrics Visualizations"__
...
* *hawkularmetric:* specifically tailored toward Single Metrics Display (default if you don't specify) __DEPRECATION WARNING: this will be replaced with *line* in the future__
