...
declare namespace Charts {
    class EmsEvent {
        ...
        constructor(timestamp: TimeInMillis, eventSource: string, provider: string, message?: string, middlewareResource?: string);
    }
    /**
    ...
    class TimelineEvent extends EmsEvent {
        ...
        row: number;
        selected: boolean;
        constructor(timestamp: TimeInMillis, eventSource: string, provider: string, message?: string, middlewareResource?: string, formattedDate?: string, color?: string, row?: number, selected?: boolean);
        /**
